// Script to set up Neon database tables using pg
import pg from "pg"
const { Client } = pg

const DATABASE_URL = "postgresql://neondb_owner:npg_lFXkQLM67dbC@ep-shy-water-ahu7l2ab-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require"
